<?php
// Piliin ang tamang header base sa role ng naka-login na user
...
<div style="display:flex; gap:2rem; flex-wrap:wrap;">
    ...
    <div style="flex:1; min-width:300px;">
        ...
        <?php if ($user['profile_picture']): ?>
            <img src="<?= htmlspecialchars($user['profile_picture']) ?>" style="width:120px; height:120px; object-fit:cover; border-radius:100px; margin-bottom:1rem; display:block;">
        <?php endif; ?>
        ...
        <?php if ($_SESSION['role'] === 'driver'): ?>
            <h3 style="margin-top:2rem;">Larawan ng Lisensya</h3>
            <?php if ($driver && $driver['license_image']): ?>
                <img src="<?= htmlspecialchars($driver['license_image']) ?>" style="width:200px; border-radius:8px; margin-bottom:1rem; display:block;">
            <?php else: ?>
    ...
    <div style="flex:1; min-width:300px;">
        ...
        <form method="POST" action="/sitrass/public/profile/update">
            <?= Csrf::field() ?>
            <div class="field">
        ...
        <h3 style="margin-top:2rem;">Palitan ang Password</h3>
        <form method="POST" action="/sitrass/public/profile/changePassword">
            <?= Csrf::field() ?>
            <div class="field">
