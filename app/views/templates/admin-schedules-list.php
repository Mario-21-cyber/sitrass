...
<?php if (!empty($_SESSION['schedule_cancel_error'])): ?>
    <div class="alert alert-error"><?= htmlspecialchars($_SESSION['schedule_cancel_error']) ?></div>
    <?php unset($_SESSION['schedule_cancel_error']); ?>
<?php endif; ?>

<div class="section-heading" style="justify-content:flex-end;">
