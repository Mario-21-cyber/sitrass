...
return [
    // Home / Landing
    'home_tagline' => 'Maaasahang biyahe sa Sibuyan Island — van reservation at rental management.',
    'home_login' => 'Login',
    ...
    'login_no_account' => 'Wala pang account? Mag-register',
    ...
    'reset_new_password' => 'Bagong Password',
    'reset_confirm_password' => 'Kumpirmahin ang Password',
    'reset_submit' => 'I-update ang Password',
    ...
    'nav_pending_accounts' => 'Mga Naghihintay na Account',
    'nav_vans' => 'Mga Van',
    'nav_locations' => 'Mga Lokasyon',
    'nav_routes' => 'Mga Ruta',
    'nav_schedules' => 'Mga Schedule',
    'nav_payments' => 'Mga Payment',
    'nav_payment_methods' => 'Mga Paraan ng Bayad',
    'nav_ratings' => 'Mga Rating',
    ...
    // Customer Nav
    'nav_search' => 'Maghanap ng Biyahe',
    'nav_my_bookings' => 'Aking Mga Booking',
    'nav_rate_trip' => 'Mag-rate ng Biyahe',
    'nav_give_feedback' => 'Magbigay ng Feedback',
    'nav_section_trips' => 'Biyahe',
    'nav_section_support' => 'Suporta',

    // Driver Nav
    'nav_my_trips' => 'Mga Booking Ko',
    'nav_scan_qr' => 'I-verify ang QR Code',
    ...
    // Natitirang karaniwang text sa interface
    'menu_label' => 'Menu',
    'role_driver' => 'Driver',
    'role_admin' => 'Admin',
    'label_reference_code' => 'Reference Code',
    'label_current_date' => 'Kasalukuyang Petsa',
    'label_passenger_count' => 'Bilang ng Pasahero',
    'label_total_amount' => 'Kabuuang Halaga',
    'label_status' => 'Status',
    'label_customer' => 'Customer',
    'label_driver' => 'Driver',
    'label_van' => 'Van',
    'label_reference' => 'Reference',
    'label_date_time' => 'Petsa/Oras',
    'label_available_seats' => 'upuang bakante',
    'label_per_seat' => 'bawat upuan',
    'label_email_readonly' => 'Email (hindi na puwedeng baguhin)',
    'label_first_name' => 'Pangalan',
    'label_last_name' => 'Apelyido',
    'label_phone' => 'Numero',
    'btn_back' => 'Bumalik',
    'btn_send' => 'Ipadala',
    'btn_save_information' => 'I-save ang Impormasyon',
    'btn_mark_in_review' => 'I-mark bilang Sinusuri',
    'btn_submit_response' => 'Isumite ang Sagot',
    'btn_make_primary' => 'Gawing Pangunahin',
    'btn_delete' => 'Burahin',
    'btn_book' => 'Mag-book',
    'btn_confirm_new_date' => 'Kumpirmahin ang Bagong Petsa',
    'empty_no_alternative_trip' => 'Walang ibang available na biyahe sa rutang ito sa ngayon.',
    'empty_no_vans' => 'Wala pang van na naitala.',
    'empty_no_vans_sub' => 'Magdagdag ng unang van para masimulan ang scheduling.',
    'empty_no_routes' => 'Wala pang ruta na naitala.',
    'empty_no_schedules' => 'Wala pang schedule na naitala.',
    'empty_no_schedules_sub' => 'Magdagdag ng schedule para makapag-book na ang customer.',
    'empty_no_ratings' => 'Wala pang rating na naitala.',
    'empty_no_feedback' => 'Wala pang feedback na naitala.',
    'empty_no_pending_payments' => 'Walang pending na payment sa ngayon.',
    'empty_all_payments_verified' => 'Lahat ng payment ay na-verify na.',
    'empty_no_trip_to_rate' => 'Wala kang biyaheng naghihintay ng rating sa ngayon.',
    'empty_no_bookings' => 'Wala ka pang booking.',
    'search_empty' => 'Walang nahanap na biyahe na tugma sa iyong hinanap.',
    'booking_confirm_title' => 'Kumpirmahin ang Booking',
    'images_empty' => 'Wala pang larawan ang van na ito.',
    'image_primary' => 'Pangunahin',
    'empty_no_locations' => 'Wala pang lokasyon na naitala.',
    'label_contact_email' => 'Email para sa Pakikipag-ugnayan',
    'settings_saved' => 'Na-save na ang mga setting.',
    'option_yes' => 'Oo',
    'option_no' => 'Hindi',
    'link_find_trip' => 'Maghanap ng biyahe',
    'heading_reschedule_trip' => 'I-reschedule ang Biyahe',
    'heading_booking_confirmed' => 'Nakumpirma ang Booking!',
    'heading_track_trip' => 'I-track ang Biyahe',
    'heading_track_customer' => 'Subaybayan ang Customer',
    'heading_qr_booking' => 'QR Code para sa Booking',
    'heading_chat_with' => 'Chat kay %s',
    'heading_send_feedback' => 'Ipadala ang Iyong Feedback',
    'qr_show_to_driver' => 'Ipakita ito sa driver kapag sumakay ka na.',
    'qr_display_error' => 'Hindi ma-display ang QR code. Kontakin ang admin.',
    'qr_alt_booking' => 'QR code para sa booking',
    'track_waiting_location' => 'Hinihintay ang datos ng lokasyon...',
    'track_waiting_customer_location' => 'Hinihintay pa ang lokasyon ng customer...',
    'track_waiting_driver_location' => 'Wala pang lokasyon na natatanggap mula sa driver.',
    'track_customer_last_seen' => 'Huling nakita ang customer: %ss ang nakalipas.',
    'track_customer_live' => 'Live ang lokasyon ng customer.',
    'map_pickup_point' => 'Pickup Point',
    'map_dropoff_point' => 'Dropoff Point',
    'map_you' => 'Ikaw',
    'map_you_van' => 'Ikaw (Van)',
    'chat_placeholder' => 'Isulat ang mensahe...',
    'status_active_qr' => 'Aktibo',
    'status_inactive_qr' => 'Hindi Aktibo',
    'status_deactivated' => 'Naka-deactivate',
    'status_hidden' => 'Nakatago',
    'status_visible' => 'Nakikita',
    'status_pending_payment' => 'Naghihintay',
    'status_pending' => 'Naghihintay',
    'status_confirmed' => 'Nakumpirma',
    'status_paid' => 'Bayad na',
    'status_completed' => 'Tapos na',
    'status_cancelled' => 'Nakansela',
    'title_password_reset' => 'I-reset ang Password',
    'title_invalid_expired_link' => 'Hindi Wasto o Expired na Link',
    'reset_request_new_link' => 'Humiling ng bagong reset link.',
