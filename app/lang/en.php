...
return [
    ...
    'error_schedule_paid_booking' => 'This schedule cannot be cancelled because it already has paid bookings.',
    ...
    'rate_edit_title' => 'Edit Rating',
    'rate_edit_note' => 'You are updating your previous rating for this trip.',
    'rate_latest_title' => 'Your Latest Rating',
    'rate_history_title' => 'Your Rating History',
    'rate_no_history' => 'You have not submitted any ratings yet.',
    'rate_no_comment' => 'No comment',
    'btn_edit_rating' => 'Edit',
    'btn_update_rating' => 'Update Rating',
    'label_category' => 'Category',
    'track_dest_label' => 'Destination',
    'track_eta_dest_label' => 'Heading to destination',
    'track_trip_ended' => 'The trip has ended!',
    'track_trip_ended_note' => 'Live trip tracking is now closed.',
    'track_dist_from_you' => 'from you',
    'track_arrived' => 'Arrived at the destination!',
    'track_arrived_note' => 'You can end the trip once the passenger has disembarked.',
    'track_arrived_customer_note' => 'The van has reached the destination. Waiting for the driver to end the trip.',
    'btn_end_trip' => 'End Trip',
    ...
    'nav_rent_van' => 'Rent a Van',
    'rent_intro' => 'Choose the van you want to hire. Pricing is per day, and you can pick a pickup point and the rental duration.',
    'rent_status_available' => 'Available',
    'rent_status_on_trip' => 'Unavailable - on a trip',
    'rent_status_maintenance' => 'Unavailable - maintenance',
    'rent_status_inactive' => 'Unavailable',
    'rent_status_rented' => 'Unavailable - rented',
    'rent_per_day' => '/ day',
    'rent_price_label' => 'Rent Price / day',
    'rent_btn_book' => 'Rent',
    'rent_unavailable_btn' => 'Unavailable',
    'rent_my_rentals' => 'My Rentals',
    'rent_no_rentals' => 'You have no van rentals yet.',
    'rent_th_van' => 'Van',
    'rent_th_dates' => 'Dates',
    'rent_th_days' => 'Days',
    'rent_th_total' => 'Total',
    'rent_th_status' => 'Status',
    'rent_pickup_location' => 'Pickup location',
    'rent_start_date' => 'Rental start',
    'rent_end_date' => 'Rental end',
    'rent_notes' => 'Notes (optional)',
    'rent_days_label' => 'Number of days',
    'rent_total_label' => 'Total amount',
    'rent_btn_confirm' => 'Submit Rental',
    'rent_back' => 'Back to list',
    'rent_success' => 'Your van rental has been submitted! Please wait for confirmation.',
    'rent_error_maintenance' => 'This van is unavailable (maintenance).',
    'rent_error_on_trip' => 'This van is currently on a trip and cannot be rented.',
    'rent_error_rented' => 'This van is already rented on those dates.',
    'rent_error_dates' => 'Invalid dates. The start must be today or later, the end cannot be earlier than the start (max 30 days).',
    'rent_error_rate' => 'This van has no rent price yet. The admin must set it first.',
    'rent_error_overlap' => 'This van already has a rental on those dates.',
    'currency_symbol' => '₱',
    'mode_seat_only_note' => 'Per-seat is now the only booking mode for schedules - whole-van rental lives on the "Rent a Van" page.',
    'tab_shared_trips' => 'Shared Trips',
    'tab_van_rentals' => 'Van Rentals',
    'rent_btn_scan_qr' => 'Scan Rental QR',
    'rent_pickup_modal_title' => 'Rental Pickup Verification (Camera / Manual)',
    'rent_pay_title' => 'Pay for Rental',
    'rent_route' => 'Trip Route',
    'rent_route_note' => 'Choose the route, same as shared bookings (e.g. San Fernando Town Proper → Magdiwang Town Proper).',
    'rent_error_route' => 'Choose the trip route.',
    'rent_th_ref' => 'Reference',
    'rent_payment_pending' => 'Awaiting payment',
    'rent_payment_paid' => 'Paid',
    'rent_pay_now' => 'Pay Deposit',
    'rent_pay_submitted' => 'Payment submitted! Wait for admin verification before getting the QR.',
    'rent_pay_submitted_f2f' => 'Payment submitted! Wait for the driver to verify your cash payment.',
    'rent_pay_submitted_gcash' => 'Payment submitted! Wait for admin verification before getting the QR.',
    'rent_f2f_verify_title' => 'Rental Cash Balance to Verify',
    'rent_f2f_verify_desc' => 'The customer paid the remaining balance in cash. Verify to mark the rental as fully paid.',
    'rent_pay_deposit' => 'Required Deposit',
    'rent_pickup_title' => 'Rental Pickup Verification',
    'rent_pickup_ph' => 'RNT-20260907-XXXX',
    'rent_pickup_btn' => 'Verify Pickup',
    'rent_pickup_note' => 'Type the RNT reference code of the customer (or scan their QR) to mark the van as on-trip.',
    'rent_pickup_ok' => '✓ Pickup verified',
    'rent_status_active_lbl' => 'On trip',
    'rent_qr_title' => 'Rental QR Code',
    'rent_qr_note' => 'The driver scans this at pickup to record that the van is now on-trip.',
    'btn_end_rental' => 'End Rental',
    'rent_ended' => 'Rental completed. Thank you!',
    'rent_cancel_success' => 'Your van rental has been cancelled.',
    'dashboard_active_rental_title' => 'Current Van Rental',
    'rent_confirm_title' => 'Confirm Rental Pickup',
    'rent_confirm_btn' => 'Confirm Pickup',
    'rent_pickup_confirmed' => 'Pickup confirmed. The van is now on-trip.',
    'rent_track_btn' => 'Track Trip',
    'rent_map_live' => 'Live rental tracking - location comes from the van GPS.',
    'btn_edit' => 'Edit',
    'btn_remove' => 'Remove',
    'label_driver' => 'Driver',
    'nav_my_vans' => 'My Vans',
    'nav_pending_vans' => 'Pending Vans',
    'myvans_add_title' => 'Add a Van',
    'myvans_none' => 'You have no registered vans yet. Use the form above to register your vehicle!',
    'myvans_added' => 'Van registered! Please wait for admin approval before it can be used on trips.',
    'myvans_updated' => 'Van details updated.',
    'myvans_plate_taken' => 'Another van already uses this plate number.',
    'myvans_edit_title' => 'Edit Van',
    'myvans_photos' => 'Van Photos',
    'myvans_upload_photo' => 'Upload a Photo',
    'myvans_prices_note' => 'Pricing: booking (base fare / per km) and whole-van rental per day',
    'myvans_owner' => 'Owner',
    'vans_pending_empty' => 'No pending vans right now.',
    'vans_approved_msg' => 'Van approved! It now appears in the Fleet Overview.',
    'vans_removed_msg' => 'Van removed.',
    'vans_updated_msg' => 'Van updated.',
    'th_make' => 'Make',
    'th_model' => 'Model',
    'label_year' => 'Year',
    'label_color' => 'Color',
    ...
    'reg_combined_title' => 'Create an Account',
